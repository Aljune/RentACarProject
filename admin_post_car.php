...
include 'config.php';
                ...
                if ($name) {
                    $query = "INSERT INTO cars (client_id,name,branch,model,year,passenger_seat,type_transmission,type,price,description,permanent_location,created_at,image,status) VALUES ('$id','$name' ,'$branch','$model', '$year', '$passenger_seat', '$type_transmission', '$type', '$price', '$description','$permanentLocation','$created_at', '$image','AVAILABLE')";
      ...
      <div id="content">
        ...
        <div class="container-fluid" >
         ...
         <div class="d-flex mb-3">
           <a href="admin_post.php"> <button class="btn border border-secondary border-2 px-4">BACK</button></a>
      </div>
