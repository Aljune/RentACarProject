...
if(!isset($_SESSION['user_id'])){
    if (isset($_GET['email']) && isset($_GET['username'])) {
        ...
        if($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            $message = "Please click the following link to confirm new password : http://localhost/rent-a-car/register/verify.php?email=$email&code=$verification_code";
            ...
            elseif ($password != $confirm_password) {
                ...
                if ($result) {
                    ...
                    if ($row['count'] > 0) {
                        ...
                        $query = mysqli_query($conn,"UPDATE tbl_user SET password = '$hashed_password' WHERE email = '$email'");
                        if($query){
            ...
            <div class="d-flex justify-content-center flex-wrap align-content-center" > 
                <form action="" method="post">
                    ...
                    <div class="form-floating mb-3  w-100">
                        <input type="password" name="password" value="" class="form-control" id="floatingInput" placeholder="USERNAME">
                        <label for="floatingInput">NEW PASSWORD</label>
                    </div>
                    <div class="form-floating mb-3 w-100">
                        <input type="password" name="confirm_password" value="" class="form-control" id="floatingInput" placeholder="email">
                        <label for="floatingInput">NEW CONFIRM PASSWORD</label>
                    </div>
