         ...
         <div class="card-body">
          <div class="row">
            ...
            <table class="table table-dark table-striped">
              <thead>
                <tr>
                  <th scope="col" style="font-size:13px;display:none;">Name</th>
              ...
              <tbody>
                ...
                $id=$_COOKIE['logid'];
                $selectreservaion = mysqli_query($conn, "SELECT *,tbl_reservation.id as  idget,tbl_reservation.status as reservestatus FROM  `tbl_reservation`  INNER JOIN  cars on cars.id=tbl_reservation.car_id  where  tbl_reservation.user_id='$id'");

                while ($reservationtItem = mysqli_fetch_assoc($selectreservaion)) { ?>
                 <tr class="content">

                   <td style="display:none;"><?php echo $reservationtItem['idget'] ?></td>
                   ...
                   <td> <?php echo $reservationtItem['reservestatus'] ?> </td>
                   <?php
                   if($reservationtItem['reservestatus']=='pending'){
                    ?>
                    <td>
                    ...
                    <?php
                  }elseif ($reservationtItem['reservestatus']=='Sending Payment') {
                    ?>
                    ...
                    <?php
                  }elseif ($reservationtItem['reservestatus']=='REJECTED') {
                    ?>
                    <td>
                      <button type='button' class='btn btn-primary btn-sm btn-flat'  data-id="<?php echo $reservationtItem['car_id'] ?>" id="viewprofile"> VIEW </button>
                      <button type='button' class='btn btn-primary btn-sm btn-flat' id="btnupdate">update payment </button>
                    ...
                    <?php 
                  }elseif ($reservationtItem['reservestatus']=='CONFIRMED') {
                    ?>
                    <td>
