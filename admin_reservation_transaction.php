        ...
        <div class="container-fluid" >
         ...
         <div class="card-body">
           ...
           <tbody>
            ...
            $selectreservaion = mysqli_query($conn, "SELECT *,CONCAT(tbl_user.first_name,' ',tbl_user.last_name) as owner,tbl_reservation.id as carid,tbl_reservation.status as rentstatus,CONCAT(tbl_reservation.first_name,' ',tbl_reservation.last_name) as customer,tbl_reservation.id as carid  FROM `cars` INNER JOIN tbl_reservation on tbl_reservation.car_id=cars.id INNER JOIN tbl_user on tbl_reservation.user_id=tbl_user.id");

            while ($reservationtItem = mysqli_fetch_assoc($selectreservaion)) { ?>
             <tr class="mycontent">
              <td style="display:none;"><?php echo $reservationtItem['carid'] ?></td>
              <td class="mytitle"><?php echo $reservationtItem['customer'] ?></td>
        ...
        <div class="row">
         <div class="col-md-4">
           ...
           <div class="form-group">
            ...
            <input type="text" name="" id="owner" class="form-control">
          </div>
        </div>
...
<div class="col-md-4">
 <div class="form-group">
  ...
  <input type="text" name="" id="ref" class="form-control">
</div>
</div>
...
<div class="col-md-4">
 <div class="form-group">
  ...
  <input type="text" name="" id="datesend" class="form-control">
</div>
</div>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $('body').on("click",'#views',function(){
     ...
     $.ajax({type: 'POST',url:'admin_reservation_transactiondb.php',data: {pay_id:pay_id},dataType: 'json',
