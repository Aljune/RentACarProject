     ...
     <?php include './admin-layout/nav-menu.php'?>
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <div class="d-flex mb-3">
           <a href="customer_post_car.php"> <button class="btn border border-secondary border-2 px-4"> ADD CAR</button></a>
        </div>
        <div class="">
        <table class="table table-dark table-striped">
            ...
            <tbody>
                ...
                <?php if($row['role'] === 'customer'):?>
                  <?php
                      $id =$_COOKIE['logid'];
                    $selectcars = mysqli_query($conn, "SELECT * FROM cars where client_id='$id' ORDER BY created_at DESC");
