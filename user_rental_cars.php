...
include 'config.php';
$id=$_COOKIE['chat_id'];
$sql="SELECT * FROM tbl_payment_setting   where   tenant_id='$id' ";
 ...
 <div class="col-md-4">
           ...
           <div style="width:100%;height:auto;border:1px solid blue;">
             ...
             <div style="width:100%;height:30px;background-color:blue;border:1px solid orange;">
               <p style="color:white;padding:5px;padding-bottom:10px;text-transform:uppercase;"><?php echo $row['payment_channel']; ?></p>
             </div>
             <div style="background-color:blue;margin-left:2%;margin-right:2%;margin-top:2%;width:95%;">
              <p  style="color:white;font-size:15px;text-align:center;width:auto;">ACCOUNT NAME</p>
            </div>
            <p style="color:black;margin:2%;position:relative;bottom:13px;text-transform:uppercase;text-align:center; " ><?php echo $row['account_name']; ?></p>

            <div style="background-color:blue;margin-left:2%;margin-right:2%;margin-top:2%;width:95%;">
              <p  style="color:white;font-size:15px;text-align:center;">ACCOUNT NUMBER</p>
            </div>
            <p style="color:black;margin:2%;position:relative;bottom:13px;"><?php echo $row['account_number']; ?></p>
          </div>
        </div>
     </div>
...
<script type="text/javascript">
  $(document).ready(function(){
   ...
   window.location.assign("user_rental_car.php");
